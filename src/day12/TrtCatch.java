...
//			System.out.println("value: "map.get(key));
		...
		//try, catch, finally
		//try 예외처리하는 구간
		//catch는 try 문에서 발생된 error가 처리되는 곳
		//catch가 여러개일떄 위에서부터 처리가 가능한 catch가 동작
		//캐치가 동작이 되면 에러(동작 멈춤) => 경고(코드잘못됨 알려줌)
		//처리가 가능한 캐치가 없을떄 에러
		
		//finally는 반드시 실행되어야하는 것 실행부분
		//try -> catch -> finally
		//try -> finally -> catch
