...
public class inquiry extends JFrame {
    ...
    private void initialize() {
        ...
        attachFileButton = new JButton(new ImageIcon("/BlueiScream/camera.png")); // Replace with actual path to the icon
        attachFileButton.setPreferredSize(new Dimension(30, 30));
...
class Dataconn {
    public static int createFile(String filePath) throws SQLException {
        // Logic to create a file record in the database and return its ID
        return 1;
    }

    public static void createInquiry(String title, String content, Timestamp createdAt, int fileId) throws SQLException {
        // Logic to create a new inquiry record in the database
    }
}
